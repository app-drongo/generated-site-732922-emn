// Enhanced by AI on 2025-08-14T16:07:31.672Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary">
              ...
              Introducing Our AI-Powered Features
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-foreground mb-6">
              ...
              <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                with Our Conversion-Focused Solutions
              </span>
            </h1>

            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Unlock the power of our cutting-edge tools and templates to create high-performing websites
              that drive real results for your business. Turn your ideas into reality faster than ever before.
            </p>
