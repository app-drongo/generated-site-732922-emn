// Enhanced by AI on 2025-08-14T16:08:26.551Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">Conversion Focused</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Unlock the power of conversion-focused web development with our modern tools and beautiful designs. 
                Join thousands of businesses who trust our platform to drive results.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@conversionfocused.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">456 Conversion Ave, Suite 200</span>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 Conversion Focused. All rights reserved.</span>
